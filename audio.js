...
let correctPassword = "SOMNIOSIDAE"; // Change Password here
...
submitBtn.addEventListener("click", function () {
  ...
  // Convert both input and correct password to lower case
  if (password.value.toLowerCase() === correctPassword.toLowerCase()) {
